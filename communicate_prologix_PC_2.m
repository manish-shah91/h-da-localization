...
%     visa_object=visa('AGILENT', 'USB0::2907::65529::1026026_150_7::0::INSTR');
% else
%     fclose(visa_object);
...
set(obj1, 'baudrate', 256000);

% Connect to instrument object, obj1.
fopen(obj1);

% Communicating with instrument object, obj1.
%data=query(obj1, '++mode')

data1=query(obj1,'++ver')
data1=query(obj1,'++mode')
fprintf(obj1,'++mode 1')
data1=query(obj1,'++mode')
fprintf(obj1,'++addr 16')
data1=query(obj1,'++addr')
...
% 
% fprintf(visa_object, 'FREQ:STAR 2400 MHZ');
% fprintf(visa_object, 'FREQ:STOP 2400 MHZ');
